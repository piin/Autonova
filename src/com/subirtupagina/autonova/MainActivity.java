...
import com.subirtupagina.autonova.adapters.AdapterLVMain;
import com.subirtupagina.autonova.application.AplicacionAutonova;
...
public class MainActivity extends Activity implements OnItemClickListener {
	...
	private void pruebaInternet() {
		...
		if( netInfo != null && netInfo.isConnectedOrConnecting()){      		
			((AplicacionAutonova) getApplication())
